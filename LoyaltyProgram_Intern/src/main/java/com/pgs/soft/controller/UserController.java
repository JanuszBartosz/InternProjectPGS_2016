...
public class UserController {
	...
	public String fillProfile(@Valid @ModelAttribute("userProfileDTO") UserProfileDTO userProfileDTO,
	...
	public ModelAndView mainPage() {
		...
		model.addObject("loggedUser", SecurityContextHolder.getContext().getAuthentication().getPrincipal());
		return model;
	}
