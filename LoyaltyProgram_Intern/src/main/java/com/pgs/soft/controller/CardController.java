...
public class CardController {
	...
	public String cardLogged(@Valid @ModelAttribute("cardLoggedDTO") AddCardRequestDTO cardLoggedDTO,
	...
	public String card(@Valid @ModelAttribute("cardNotLoggedDTO") AddCardNotLoggedRequestDTO cardNotLoggedDTO,
			BindingResult result) {
		if (!result.hasErrors()) {
